...
public class Level {
	...
	private void loadLevel() {
		...
		for (int y = 0; y < img.getHeight(); y++)
			for (int x = 0; x < img.getWidth(); x++) {
				...
				//qui analizza punto punto tutta la mappa e ne estrae i valori RGB 
	...
	private void loadObjects(int blueValue, int x, int y) {
		...
		case TREASURE -> treasures.add(new Treasure(x * Game.TILES_SIZE, y * Game.TILES_SIZE, blueValue));
		case CHECKPOINT -> checkpoints.add(new Checkpoint(x * Game.TILES_SIZE, y * Game.TILES_SIZE, CHECKPOINT));
