...
public class Constants {
	...
	public static class ObjectConstants {
		...
		public static final int TREASURE = 11;

		public static final int TREASURE_WIDTH_DEFAULT = 40;
		public static final int TREASURE_HEIGHT_DEFAULT = 40;
		public static final int TREASURE_WIDTH  = (int) (Game.SCALE * TREASURE_WIDTH_DEFAULT);
		public static final int TREASURE_HEIGHT = (int) (Game.SCALE * TREASURE_HEIGHT_DEFAULT);
		public static final int TREASURE_SPRITE_COUNT = 6;
		
		
		public static final int CHECKPOINT = 12; 
		//40*64
		public static final int CHECKPOINT_WIDTH_DEFAULT = 40;
		public static final int CHECKPOINT_HEIGHT_DEFAULT = 64;
		public static final int CHECKPOINT_WIDTH  = (int) (Game.SCALE * CHECKPOINT_WIDTH_DEFAULT);
		public static final int CHECKPOINT_HEIGHT = (int) (Game.SCALE * CHECKPOINT_HEIGHT_DEFAULT);
		// quante sprite ha (per ora una sola)
		public static final int CHECKPOINT_SPRITE_COUNT = 1;
		...
		public static int GetSpriteAmount(int object_type) {
			...
			case CANNON_LEFT, CANNON_RIGHT:
				return 7;
			case TREASURE:
			    return TREASURE_SPRITE_COUNT;
			case CHECKPOINT:                
				return CHECKPOINT_SPRITE_COUNT;
			}
			return 1;
		}
