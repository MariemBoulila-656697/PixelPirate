...
public class HelpMethods {
	...
	//controlla se una coordinata pixel tocca una piastrella ovvero un tile solido o se è fuori dai limiti della mappa 
	private static boolean IsSolid(float x, float y, int[][] lvlData) {
		//larghezza massima della mappa in pixel 
